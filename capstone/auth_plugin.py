...
class RackspaceIdentity(object):
    ...
    def from_token(cls, token_id, scope_project_id=None, x_forwarded_for=None):
        return cls(None, None, None, token_id=token_id,
                   scope_project_id=scope_project_id,
                   x_forwarded_for=x_forwarded_for)
    ...
    def _token_authenticate(self):
        cached_data = cache.token_region.get(self._token_id)
        if cached_data:
            return cached_data
        ...
        cache.token_region.set(self._token_id, token_data)
        return token_data
