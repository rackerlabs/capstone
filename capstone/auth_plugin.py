...
class RackspaceIdentity(object):
    ...
    def authenticate(self, context=None):
        ...
        # FIXME(dstanek): only needed because of the admin creds
        if self._user_ref:
        ...
        token_data = self._authenticate(context, self._username)
    ...
    def _authenticate(self, context, username):
