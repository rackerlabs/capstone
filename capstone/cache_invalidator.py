...
class CloudFeedClient(object):
    ...
    def read(self):
        ...
        self.entries = []
        s = requests.Session()
        self._page_feed(s, endpoint, headers)
        if self.entries:
