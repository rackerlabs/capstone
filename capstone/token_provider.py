...
class RackspaceTokenDataHelper(object):
    ...
    def get_token_data(self, user_id, method_names, extras=None,
                       ...
                       audit_info=None):
        LOG.info(_LI('Building token data for user %s.'), user_id)
        token_data = {
        ...
        LOG.info(_LI('Successfully builded token data for user %s.'), user_id)
...
class Provider(common.BaseProvider):
    ...
    def issue_v3_token(self, user_id, method_names, expires_at=None,
        ...
        LOG.info(_LI('Issuing v3 token for user %s.'), user_id)
        expires_at = (
