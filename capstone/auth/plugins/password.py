...
class Password(auth.AuthMethodHandler):
    ...
    def _validate_auth_data(self, auth_payload, scope):
    ...
    def authenticate(self, context, auth_payload, auth_context):
        ...
        self._validate_auth_data(auth_payload, scope)
        ...
        scope_project_domain_id = None
        scope_project_domain_name = None
        if scope_project_domain:
